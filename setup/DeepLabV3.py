...
class ResNet_BasicBlock_OS8(nn.Module):
    def __init__(self, num_layers=18):
        ...
        resnet.load_state_dict(torch.load("setup/resnet18-5c106cde.pth"))
...
class DeepLabV3(nn.Module):
    def __init__(self):
        ...
        self.resnet = ResNet_BasicBlock_OS8() # NOTE! specify the type of ResNet here
    ...
    def forward(self, x):
        ...
        output = F.interpolate(output, size=(h, w)) # (shape: (batch_size, num_classes, h, w))
