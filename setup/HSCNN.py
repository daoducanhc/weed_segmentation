...
class HSCNN(nn.Module):
    ...
    def make_layer(self,num_layers):
        ...
        for i in range(num_layers):
            layers.append(conv_relu_res_relu_block()) # there is a ()
